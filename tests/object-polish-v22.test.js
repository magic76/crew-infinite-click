...
assert(game.includes('OBJECT_POLISH_WORLD_V22'),'v22 renderer id missing');
...
assert(gradle.includes('versionCode 400')&&gradle.includes("versionName '0.51.0-object-polish-v22'"),'v22 version missing');
