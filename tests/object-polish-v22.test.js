...
assert(game.includes('OBJECT_POLISH_WORLD_V22')||game.includes('TAP_VARIETY_V23'),'v22+ renderer id missing');
...
assert(/versionCode\s+(400|401)/.test(gradle)&&(/0\.51\.0-object-polish-v22/.test(gradle)||/0\.52\.0-tap-variety-v23/.test(gradle)),'v22+ version missing');
