...
assert(game.includes('OBJECT_POLISH_WORLD_V22')||game.includes('TAP_VARIETY_V23')||game.includes('ACTION_BUTTON_V24')||game.includes('OVERDRIVE_SCENE_V25'),'v22+ renderer id missing');
...
assert(/versionCode\s+(400|401|402|403)/.test(gradle)&&(/0\.51\.0-object-polish-v22/.test(gradle)||/0\.52\.0-tap-variety-v23|0\.53\.0-action-button-v24|0\.54\.0-overdrive-scene-v25/.test(gradle)),'v22+ version missing');
