...
assert(game.includes('ASSET_ART_V17')||game.includes('WORLD_MAP_VISIBILITY_V21')||game.includes('OBJECT_POLISH_WORLD_V22')||game.includes('TAP_VARIETY_V23')||game.includes('ACTION_BUTTON_V24')||game.includes('OVERDRIVE_SCENE_V25')||game.includes('WORLD_RULES_CAST_V20'),'v17+ renderer lineage missing');
...
assert(/versionCode\s+(395|396|397|398|399|400|401|402|403)/.test(gradle),'v17+ gradle version missing');
