...
assert(game.includes('ASSET_ART_V17'),'v16 renderer id missing');
...
assert(gradle.includes('versionCode 395')&&gradle.includes("versionName '0.46.0-asset-art-v17'"),'v16 version missing');
