...
assert(game.includes('PRODUCTION_ART_WORLD_V19')||game.includes('WORLD_RULES_CAST_V20')||game.includes('OBJECT_POLISH_WORLD_V22')||game.includes('TAP_VARIETY_V23')||game.includes('ACTION_BUTTON_V24')||game.includes('OVERDRIVE_SCENE_V25')||game.includes('VISIBLE_SHOOTING_V26'),'v19+ world renderer lineage missing');
...
assert(/versionCode\s+(397|398|399|400|401|402|403|404)/.test(gradle),'v19+ gradle version missing');
