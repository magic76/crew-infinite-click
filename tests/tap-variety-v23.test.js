...
assert(/versionCode\s+(401|402|403|404)/.test(gradle),'v23+ versionCode missing');
assert(/0\.(52\.0-tap-variety-v23|53\.0-action-button-v24|54\.0-overdrive-scene-v25|55\.0-visible-shooting-v26)/.test(gradle),'v23+ versionName missing');
