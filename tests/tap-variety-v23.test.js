...
assert(game.includes('TAP_VARIETY_V23'),'v23 renderer id missing');
...
assert(/versionCode\s+401/.test(gradle),'v23 versionCode missing');
assert(/0\.52\.0-tap-variety-v23/.test(gradle),'v23 versionName missing');
