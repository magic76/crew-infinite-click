...
assert(game.includes('WORLD_RULES_CAST_V20')||game.includes('WORLD_MAP_VISIBILITY_V21')||game.includes('OBJECT_POLISH_WORLD_V22'),'v20+ renderer id missing');
...
assert(/versionCode\s+(398|399|400|401|401)/.test(gradle)&&(/0.49.0-world-rules-v20/.test(gradle)||/0.50.0-world-visibility-v21|51.0-object-polish-v22|52.0-tap-variety-v23/.test(gradle)||/0.51.0-object-polish-v22|0.52.0-tap-variety-v23/.test(gradle)),'v20+ gradle version missing');
