...
assert(game.includes('WORLD_MAP_VISIBILITY_V21')||game.includes('OBJECT_POLISH_WORLD_V22'),'v21+ renderer id missing');
...
assert(/versionCode\s+(399|400|401)/.test(gradle)&&(/0\.50\.0-world-visibility-v21/.test(gradle)||/0\.51\.0-object-polish-v22|0\.52\.0-tap-variety-v23/.test(gradle)),'v21+ gradle version missing');
