(function (global) {
  ...
  class GeminiEventAggregator {
    ...
    flush(){
      ...
      this.flushCount++;
      const payload={mode:directive.mode,reason:directive.reason||"aggregated",delivery:directive.delivery||"DRY",voiceWanted:false,instruction:directive.instruction||"",context,behavior:summary};
